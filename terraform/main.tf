...
module "vpc" {
  ...
  main_thandi_ssh_sg_descripion           = var.main_thandi_ssh_sg_descripion
  ...
  main_http_cidr_http_sg_descripion       = var.main_http_cidr_http_sg_descripion
  ...
  main_thandi_prometheus_sg_descripion    = var.main_thandi_prometheus_sg_descripion
  ...
  main_thandi_node_exporter_sg_descripion = var.main_thandi_node_exporter_sg_descripion
  ...
  main_allow_all_traffic_sg_descripion    = var.main_allow_all_traffic_sg_descripion
